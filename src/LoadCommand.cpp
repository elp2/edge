...
void LoadCommand::Run(CPU *cpu, MMU *mmu) {
    ...
    if (from16Bit) {
        ...
        if (to16Bit) {
            cpu->Set16Bit(to, cpu->Read8Bit(from));
        } else {
...
class SpecialLoadCommand : public Command {
 public:
    ...
    void Run(CPU *cpu, MMU *mmu) {
        if (opcode == 0xF8) {
            uint8_t offset = cpu->Read8Bit(Eat_PC_Byte);
        ...
        {
        case 0xf2:
            address = 0xff00 + cpu->Read8Bit(Register_C);
            value = mmu->ByteAt(address);
            cpu->Set8Bit(Register_A, value);
            break;
        case 0xf0:
            // LD A,($FF00+n) F0 12
            address = 0xff00 + cpu->Read8Bit(Eat_PC_Byte);
            value = mmu->ByteAt(address);
            cpu->Set8Bit(Register_A, value);
            break;
        case 0xe2:
            address = 0xff00 + cpu->Read8Bit(Register_C);
            mmu->SetByteAt(address, cpu->Read8Bit(Register_A));
            break;
        case 0xe0:
            address = 0xff00 + cpu->Read8Bit(Eat_PC_Byte);
            mmu->SetByteAt(address, cpu->Read8Bit(Register_A));
        ...
        case 0x2a:
            ...
            break;
        case 0x32:
            mmu->SetByteAt(cpu->Read16Bit(Register_HL), cpu->Read8Bit(Register_A));
...
void registerSpecialLoadCommands(CPU *cpu) {
    cpu->RegisterCommand(new SpecialLoadCommand(0xf2, "LD A,(C)", 8));
    cpu->RegisterCommand(new SpecialLoadCommand(0xe2, "LD ($FF00+C),A", 8));

    cpu->RegisterCommand(new SpecialLoadCommand(0x3a, "LD A,(HL-)", 8));
    cpu->RegisterCommand(new SpecialLoadCommand(0x32, "LD (HL-),A", 8));

    cpu->RegisterCommand(new SpecialLoadCommand(0x2a, "LD A,(HL+)", 8));
    cpu->RegisterCommand(new SpecialLoadCommand(0x22, "LD (HL+),A", 8));

    cpu->RegisterCommand(new SpecialLoadCommand(0xe0, "LD ($FF00+n),A", 12));
    cpu->RegisterCommand(new SpecialLoadCommand(0xf0, "LD A,($FF00+n)", 12));

    cpu->RegisterCommand(new SpecialLoadCommand(0xf8, "LDHL SP,n", 12));
}

void register16BitLoadCommands(CPU *cpu) {
    // TODO: Clean these up.
    ...
    cpu->RegisterCommand(new LoadCommand(0xF9, "LD SP,HL", Register_SP, Register_HL, 8));
    cpu->RegisterCommand(new LoadCommand(0x08, "LD (nn),SP", Address_nn, Register_SP, 20));    
}

void registerLoadCommands(CPU *cpu) {
    register16BitLoadCommands(cpu);
    registerSpecialLoadCommands(cpu);
    ...
    cpu->RegisterCommand(new LoadCommand(0x02, "LD (BC),A", Address_BC, Register_A, 8));
    cpu->RegisterCommand(new LoadCommand(0x12, "LD (DE),A", Address_DE, Register_A, 8));
    cpu->RegisterCommand(new LoadCommand(0x77, "LD (HL),A", Address_HL, Register_A, 8));
    cpu->RegisterCommand(new LoadCommand(0xEA, "LD (nn),A", Address_nn, Register_A, 16));
    cpu->RegisterCommand(new LoadCommand(0x01, "LD BC,nn", Register_BC, Eat_PC_Word, 12));
    cpu->RegisterCommand(new LoadCommand(0x11, "LD DE,nn", Register_DE, Eat_PC_Word, 12));
    cpu->RegisterCommand(new LoadCommand(0x21, "LD HL,nn", Register_HL, Eat_PC_Word, 12));
    cpu->RegisterCommand(new LoadCommand(0x31, "LD SP,nn", Register_SP, Eat_PC_Word, 12));
    ...
    cpu->RegisterCommand(new LoadCommand(0x7E, "LD A,(HL)", Register_A, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x46, "LD B,(HL)", Register_B, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x4E, "LD C,(HL)", Register_C, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x56, "LD D,(HL)", Register_D, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x5E, "LD E,(HL)", Register_E, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x66, "LD H,(HL)", Register_H, Address_HL, 8));
    ...
    cpu->RegisterCommand(new LoadCommand(0x6E, "LD L,(HL)", Register_L, Address_HL, 8));
    cpu->RegisterCommand(new LoadCommand(0x70, "LD (HL),B", Address_HL, Register_B, 8));
    cpu->RegisterCommand(new LoadCommand(0x71, "LD (HL),C", Address_HL, Register_C, 8));
    cpu->RegisterCommand(new LoadCommand(0x72, "LD (HL),D", Address_HL, Register_D, 8));
    cpu->RegisterCommand(new LoadCommand(0x73, "LD (HL),E", Address_HL, Register_E, 8));
    cpu->RegisterCommand(new LoadCommand(0x74, "LD (HL),H", Address_HL, Register_H, 8));
    cpu->RegisterCommand(new LoadCommand(0x75, "LD (HL),L", Address_HL, Register_L, 8));
    cpu->RegisterCommand(new LoadCommand(0x36, "LD (HL),n", Address_HL, Eat_PC_Byte, 12));
    cpu->RegisterCommand(new LoadCommand(0x0A, "LD A,(BC)", Register_A, Address_BC, 8));
    cpu->RegisterCommand(new LoadCommand(0x1A, "LD A,(DE)", Register_A, Address_DE, 8));
    cpu->RegisterCommand(new LoadCommand(0xFA, "LD A,(nn)", Register_A, Address_nn, 16));
    cpu->RegisterCommand(new LoadCommand(0x3E, "LD A,#", Register_A, Eat_PC_Byte, 8));
