...
class WaveVoice {
 public:
    ...
    // Will also potentially make this voice ready for playback if "initial" is set.
 ...
 private:
    ...
    float *sound_buffer_;
	// Length of the internal buffer which we should play. May be less than real size if we're playing a shorter sound.
